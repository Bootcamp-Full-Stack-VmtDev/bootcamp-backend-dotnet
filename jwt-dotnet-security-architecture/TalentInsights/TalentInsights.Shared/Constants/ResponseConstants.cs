namespace TalentInsights.Shared.Constants
{
    public static class ResponseConstants
    {
        ...
        {
            return $"Ha ocurrido un error inesperador: Contacto con soporte, mencionando el siguiente código de error: {traceId}";
        }

        public static string ConfigurationPropertyNotFound(string property)
        {
            return $"Falta la propiedad {property} por establecer en la configuracion de la aplicacion";
        }
    }
}
